<template>
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
      ...
      <aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-primary-darker dark:bg-darker md:block">
        <div class="flex flex-col h-full">
          ...
          <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
            <!-- Dashboards links -->
            <!-- isActive here just for demo active classes -->
            <div x-data="{ isActive: true, open: true}">
              ...
              <div x-show="open" class="mt-2 space-y-2 px-7">
                ...
                <a
                  ...
                  :class="{'text-gray-700 dark:text-light': isActive, 'text-gray-400 dark:text-gray-400': !isActive}"
                >
                  Default
                </a>
                <a
            ...
            <div x-data="{ isActive: false, open: false }">
              ...
              >
                ...
                <span class="ml-2 text-sm"> Components (soon) </span>
                <span class="ml-auto">
                  <!-- active class 'rotate-180' -->
                  <svg
                    class="w-4 h-4 transition-transform transform"
            ...
            <div x-data="{ isActive: false, open: false }">
              ...
              >
                ...
                <span class="ml-2 text-sm"> Pages (soon) </span>
                <span class="ml-auto">
                  <!-- active class 'rotate-180' -->
                  <svg
                    class="w-4 h-4 transition-transform transform"
            ...
            <div x-data="{ isActive: false, open: false}">
              ...
              >
                ...
                <span class="ml-2 text-sm"> Authentication (soon) </span>
                <span class="ml-auto">
                  <!-- active class 'rotate-180' -->
                  <svg
                    class="w-4 h-4 transition-transform transform"
        ...
        <header class="relative bg-white dark:bg-darker">
          <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
            ...
            <nav class="hidden space-x-2 md:flex md:items-center">
              ...
              <!-- Search button -->
              <button
                @click="isSearchPanelOpen = true; $nextTick(() => { $refs.searchInput.focus() })"
                class="p-2 transition-colors duration-200 rounded-full text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark focus:outline-none focus:bg-primary-100 dark:focus:bg-primary-dark focus:ring-primary-darker"
              >
                <svg
                  class="w-7 h-7"
              ...
              <div class="relative" x-data="{ open: false }">
                ...
                >
                  <img class="w-10 h-10 rounded-full" src="public/build/avatar.jpg" alt="Ahmed Kamel" />
                </button>
                ...
                <div
                  ...
                  class="absolute right-0 w-48 py-1 bg-white rounded-md shadow-lg top-12 ring-1 ring-black ring-opacity-5 dark:bg-dark"
                >
                  <a
                    href="#"
            ...
            >
              <div class="space-x-2">
                ...
                <!-- Notification button -->
                <button
                  @click="isNotificationsPanelOpen = true; $nextTick(() => { isMobileSubMenuOpen = false })"
                  class="p-2 transition-colors duration-200 rounded-full text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark focus:outline-none focus:bg-primary-100 dark:focus:bg-primary-dark focus:ring-primary-darker"
                >
                  <svg
                    class="w-7 h-7"
                ...
                <!-- Search button -->
                <button
                  @click="isSearchPanelOpen = true; $nextTick(() => { $refs.searchInput.focus(); setTimeout(() => {isMobileSubMenuOpen= false}, 100) })"
                  class="p-2 transition-colors duration-200 rounded-full text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark focus:outline-none focus:bg-primary-100 dark:focus:bg-primary-dark focus:ring-primary-darker"
                >
                  <svg
                    class="w-7 h-7"
                ...
                <!-- Settings button -->
                <button
                  @click="isSettingsPanelOpen = true; $nextTick(() => { isMobileSubMenuOpen = false })"
                  class="p-2 transition-colors duration-200 rounded-full text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark focus:outline-none focus:bg-primary-100 dark:focus:bg-primary-dark focus:ring-primary-darker"
                >
                  <svg
                    class="w-7 h-7"
          ...
          <div
            ...
            @click.prevent="isMobileMainMenuOpen = false"
          >
      ...
      <div
        ...
        class="fixed inset-0 z-10 bg-opacity-25 bg-primary-darker"
      ></div>
      <!-- Panel -->
      <div
        ...
        x-show="isSettingsPanelOpen"
        class="fixed inset-y-0 right-0 z-20 w-full max-w-xs bg-white shadow-xl dark:bg-darker dark:text-light sm:max-w-md"
      >
        ...
        <div class="flex flex-col h-screen">
          ...
          >
            ...
            <h5 class="text-xl font-medium text-gray-500 dark:text-light">Settings</h5>
          </div>
          <!-- Content -->
          <div class="flex-1 overflow-hidden hover:overflow-y-auto">
            <!-- Theme -->
            <div class="p-4 space-y-4 md:p-8">
              <h6 class="text-lg font-medium text-gray-400 dark:text-light">Theme</h6>
      ...
      <div
        ...
        x-transition:leave-end="-translate-x-full"
        x-show="isNotificationsPanelOpen"
        class="fixed inset-y-0 z-20 w-full max-w-xs bg-white dark:bg-darker dark:text-light sm:max-w-md"
      >
        ...
        <div class="flex flex-col h-screen" x-data="{ activeTabe: 'action' }">
          ...
          <div class="flex-shrink-0">
            <div class="flex items-center justify-between px-4 pt-4 border-b dark:border-primary-darker">
              <h1 class="pb-4 font-semibold">Notifications</h1>
              <div class="space-x-2">
                <button
                ...
                <div class="flex px-4 space-x-4">
                  <div class="relative flex-shrink-0">
                    <span class="relative z-10 inline-block overflow-visible rounded-ful">
                      <img class="object-cover rounded-full w-9 h-9" src="public/build/avatar.jpg" alt="Ahmed kamel" />
                    </span>
                    <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                  </div>
                  <div class="flex-1 overflow-x-hidden">
      ...
      <div
        ...
        x-transition:leave-end="-translate-x-full"
        x-show="isSearchPanelOpen"
        class="fixed inset-y-0 z-20 w-full max-w-xs bg-white shadow-xl dark:bg-darker dark:text-light sm:max-w-md"
      >
        <div class="absolute right-0 p-2 transform translate-x-full">
          <!-- Close button -->
        ...
        <div class="flex flex-col h-screen">
          ...
          <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
            <h4 class="py-2 text-sm font-semibold text-gray-600 dark:text-light">History</h4>
            <a href="#" class="flex space-x-4">
              <div class="flex-shrink-0">
                <img class="w-10 h-10 rounded-lg" src="http://placeimg.com/640/480/cats" alt="Post cover" />
              </div>
              <div class="flex-1 max-w-xs overflow-x-hidden">
                <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Header</h5>
                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
            ...
            <a href="#" class="flex space-x-4">
              <div class="flex-shrink-0">
                <img class="w-10 h-10 rounded-lg" src="public/build/avatar.jpg" alt="Ahmed Kamel" />
              </div>
              <div class="flex-1 max-w-xs overflow-x-hidden">
                <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmed Kamel</h5>
                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
            ...
            <a href="#" class="flex space-x-4">
              <div class="flex-shrink-0">
                <img class="w-10 h-10 rounded-lg" src="http://placeimg.com/640/480/cats" alt="K-WD Dashboard" />
              </div>
              <div class="flex-1 max-w-xs overflow-x-hidden">
                <h5 class="text-sm font-semibold text-gray-600 dark:text-light">K-WD Dashboard</h5>
                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
