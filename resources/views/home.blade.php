              ...
              <div class="row">
                <div class="col-sm-4">
                  <ul class="graphl-legend-rectangle">
                    ...
                    <li>
                      <span class="bg-success"></span>Video games
                    </li>
                  </ul>
                </div>
            ...
            <div class="col-lg-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <ul class="graphl-legend-rectangle">
                    <li>
                      <span class="bg-danger"></span>Instagram (15%)
                    </li>
                    <li>
                      <span class="bg-warning"></span>Facebook (20%)
                    </li>
                    <li>
                      <span class="bg-info"></span>Website (25%)
                    </li>
                    <li>
                      <span class="bg-success"></span>Youtube (40%)
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="card congratulation-bg text-center">
        <div class="card-body pb-0">
          <img src="{{asset('layout')}}/images/dashboard/face29.png" alt="" />
        ...
        <div class="col-sm-12 grid-margin d-flex stretch-card">
          <div class="card">
            <div class="card-body">
                ...
                <div class="dropdown">
                  ...
                  >
                    <a class="dropdown-item">
                      <i
                        class="mdi mdi-grease-pencil text-primary"
                      ></i>
                      Edit
                    </a>
                    <a class="dropdown-item">
              ...
              <div>
                <ul
                  class="nav nav-tabs tab-no-active-fill"
                  role="tablist"
                >
                  <li class="nav-item">
                    <a
                ...
                <div
                  class="tab-content tab-no-active-fill-tab-content"
                >
                  <div
                  ...
                  >
                    <div class="d-lg-flex justify-content-between">
                      ...
                      <div
                        ...
                        class="revenuechart-legend"
                      >
                        f
                      </div>
                    </div>
                    <canvas
                      id="revenue-for-last-month-chart"
                    ></canvas>
                  </div>
                  <div
                    class="tab-pane fade"
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <div class="d-lg-flex align-items-baseline mb-3">
                    <h1 class="text-dark font-weight-bold">
                      23<sup class="font-weight-light"
                        ><small>o</small
                ...
                <div class="col-lg-4">
                  <div class="position-relative">
                    <img
                      src="{{asset('layout')}}/images/dashboard/live.png"
                      class="w-100"
                      alt=""
                    />
                    <div class="live-info badge badge-success">
                      Live
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-12 mt-4 mt-lg-0">
                  <div class="bg-primary text-white px-4 py-4 card">
                    <div class="row">
                      ...
                      <div
                        class="col-sm-6 climate-info-border mt-lg-0 mt-2"
                      >
                        <h2>$2650</h2>
              ...
              <div class="row pt-3 mt-md-1">
                <div class="col">
                  <div
                    class="d-flex purchase-detail-legend align-items-center"
                  >
                    <div id="circleProgress1" class="p-2"></div>
                    <div>
                      <p
                        class="font-weight-medium text-dark text-small"
                      >
                        Sessions
                      </p>
                ...
                <div class="col-sm-12">
                  ...
                  >
                    ...
                    <div class="dropdown">
                      <a
                        href="#"
                        class="text-success btn btn-link px-1"
                        ><i class="mdi mdi-refresh"></i
                      ></a>
                      <a
                        href="#"
  ...
  <div class="row">
        ...
        <div class="card-body">
          ...
          >
            ...
            <h4 class="text-success font-weight-bold">
              Tickets<span class="text-dark ml-3">163</span>
            </h4>
          </div>
          <div
    ...
    <div class="col-sm-6 grid-margin grid-margin-md-0 stretch-card">
      <div class="card">
        <div class="card-body">
          <div
            class="d-lg-flex align-items-center justify-content-between mb-4"
          >
