function Marker(e) {
    google.maps.Marker.apply(this, arguments), e.map_icon_label && ((this.MarkerLabel = new MarkerLabel({ map: this.map, marker: this, text: e.map_icon_label })), this.MarkerLabel.bindTo("position", this, "position"));
}
...
(MarkerLabel.prototype = new google.maps.OverlayView()),
    ...
    (function (e, t) {
        ...
        (a.prototype = new t()),
            ...
            d &&
                (d.fn.imagesLoaded = function (e, t) {
    ...
    (function (e, t) {
        ...
        "function" == typeof define && define.amd
            ...
            : (e.getSize = s(e.getStyleProperty));
    })(window),
    (function (e) {
        function t(e) {
    ...
    (function (e, t) {
        ...
        (n.isArray = function (e) {
            ...
            (n.makeArray = function (e) {
                var t = [];
                if (n.isArray(e)) t = e;
                else if (e && "number" == typeof e.length) for (var i = 0, o = e.length; o > i; i++) t.push(e[i]);
                else t.push(e);
                return t;
            }),
    ...
    (function (e, t) {
        "use strict";
        "function" == typeof define && define.amd
            ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property", "fizzy-ui-utils/utils"], function (i, n, o, s) {
                  return t(e, i, n, o, s);
              })
            : "object" == typeof exports
        ...
        (a.prototype.enableTransition = function () {
            this.isTransitioning || (this.css({ transitionProperty: v, transitionDuration: this.layout.options.transitionDuration }), this.element.addEventListener(m, this, !1));
        }),
    ...
    (function (e, t) {
        "use strict";
        "function" == typeof define && define.amd
            ? define("outlayer/outlayer", ["eventie/eventie", "eventEmitter/EventEmitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function (i, n, o, s, a) {
            ...
            var r = e(window).width(),
                ...
                c = function () {
                    a.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'),
                        ...
                        a.css({ width: "horizontal" == s.settings.mode ? 100 * s.children.length + 215 + "%" : "auto", position: "relative" }),
                        ...
                        s.viewport.parent().css({ maxWidth: m() }),
                    ...
                    "all" == s.settings.preloadImages && (t = s.children),
                        s.settings.ticker
                            ? (s.settings.pager = !1)
                            : (s.settings.pager && S(), s.settings.controls && C(), s.settings.auto && s.settings.autoControls && T(), (s.settings.controls || s.settings.autoControls || s.settings.pager) && s.viewport.after(s.controls.el)),
                        u(t, h);
                },
                u = function (t, i) {
                ...
                v = function () {
                    ...
                    if (s.settings.moveSlides > 0)
                        ...
                        else for (var t = 0, i = 0; t < s.children.length; ) ++e, (t = i + g()), (i += s.settings.moveSlides <= g() ? s.settings.moveSlides : g());
                    ...
                    if (s.usingCSS) {
                        ...
                        a.css("-" + s.cssPrefix + "-transition-duration", i / 1e3 + "s"),
                            "slide" == t
                                ...
                                ? a.css(s.animProp, o)
                                : "ticker" == t &&
                                  (a.css("-" + s.cssPrefix + "-transition-timing-function", "linear"),
                                  a.css(s.animProp, o),
                                  a.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
                        ...
                        (r[s.animProp] = e),
                            "slide" == t
                                ? a.animate(r, i, s.settings.easing, function () {
                                      F();
                                  })
                                : "reset" == t
                                ? a.css(s.animProp, e)
                                : "ticker" == t &&
                                  a.animate(r, speed, "linear", function () {
                ...
                S = function () {
                    s.settings.pagerCustom
                        ...
                        : ((s.pagerEl = e('<div class="bx-pager" />')), s.settings.pagerSelector ? e(s.settings.pagerSelector).html(s.pagerEl) : s.controls.el.addClass("bx-has-pager").append(s.pagerEl), x()),
                ...
                P = function (t) {
                    ...
                    return "short" == s.settings.pagerType
                        ? (s.settings.maxSlides > 1 && (i = Math.ceil(s.children.length / s.settings.maxSlides)), void s.pagerEl.html(t + 1 + s.settings.pagerShortSeparator + i))
                ...
                F = function () {
                    if (s.settings.infiniteLoop) {
                        ...
                        0 == s.active.index
                            ...
                            ? (e = s.children.eq((v() - 1) * y()).position())
                ...
                H = function (e) {
                    ...
                    if (((s.touch.end.x = t.changedTouches[0].pageX), (s.touch.end.y = t.changedTouches[0].pageY), "fade" == s.settings.mode)) {
                        ...
                        "horizontal" == s.settings.mode ? ((n = s.touch.end.x - s.touch.start.x), (i = s.touch.originalPos.left)) : ((n = s.touch.end.y - s.touch.start.y), (i = s.touch.originalPos.top)),
                            !s.settings.infiniteLoop && ((0 == s.active.index && n > 0) || (s.active.last && 0 > n))
                                ? w(i, "reset", 200)
                                : Math.abs(n) >= s.settings.swipeThreshold
                                ? (0 > n ? a.goToNextSlide() : a.goToPrevSlide(), a.stopAuto())
                                : w(i, "reset", 200);
                    }
    ...
    !(function (e) {
        ...
        function t(t) {
            ...
            if (
                ...
                "axis" in a && a.axis === a.HORIZONTAL_AXIS && ((u = -1 * h), (h = 0)),
                (d = 0 === h ? u : h),
                "deltaY" in a && ((h = -1 * a.deltaY), (d = h)),
                "deltaX" in a && ((u = a.deltaX), 0 === h && (d = -1 * u)),
                0 !== h || 0 !== u)
            ) {
                if (1 === a.deltaMode) {
                ...
                if (
                    ...
                    (!s || s > p) && ((s = p), n(a, p) && (s /= 40)),
                    n(a, p) && ((d /= 40), (u /= 40), (h /= 40)),
            ...
            var t,
                                ...
                                "x" !== s.axis &&
                                    (o.overflowed[0]
                                        ? l[0].height() > l[0].parent().height()
                                            ? k.call(this)
                                            : (Y(t, d[0].toString(), { dir: "y", dur: 0, overwrite: "none" }), (o.contentReset.y = null))
                                        : (k.call(this), "y" === s.axis ? _.call(this) : "yx" === s.axis && o.overflowed[1] && Y(t, d[1].toString(), { dir: "x", dur: 0, overwrite: "none" }))),
                                    "y" !== s.axis &&
                                        (o.overflowed[1]
                                            ? l[1].width() > l[1].parent().width()
                                                ? k.call(this)
                                                : (Y(t, d[1].toString(), { dir: "x", dur: 0, overwrite: "none" }), (o.contentReset.x = null))
                                            : (k.call(this), "x" === s.axis ? _.call(this) : "yx" === s.axis && o.overflowed[0] && Y(t, d[0].toString(), { dir: "y", dur: 0, overwrite: "none" }))),
                                    i &&
                                        o &&
                ...
                v = function () {
                    ...
                    "y" === s.axis || s.advanced.autoExpandHorizontalScroll || f.css("width", y(f)),
                        "outside" === s.scrollbarPosition
                            ? ("static" === t.css("position") && t.css("position", "relative"), t.css("overflow", "visible"), m.addClass("mCSB_outside").after(d))
                            : (m.addClass("mCSB_inside").append(d), f.wrap(u)),
                        w.call(this);
                ...
                b = function () {
                    ...
                    if (o.advanced.autoExpandHorizontalScroll && "y" !== o.axis) {
                        ...
                        3 === o.advanced.autoExpandHorizontalScroll || (2 !== o.advanced.autoExpandHorizontalScroll && a > s.parent().width())
                            ? s.css({ width: a, "min-width": "100%", "overflow-x": "inherit" })
                            : s
                ...
                w = function () {
                    var t = e(this),
                        ...
                        r = [
                            "<a href='#' class='" + c[13] + "' oncontextmenu='return false;' " + a + " />",
                            "<a href='#' class='" + c[14] + "' oncontextmenu='return false;' " + a + " />",
                            "<a href='#' class='" + c[15] + "' oncontextmenu='return false;' " + a + " />",
                            "<a href='#' class='" + c[16] + "' oncontextmenu='return false;' " + a + " />",
                        ],
                ...
                x = function () {
                    var t = e(this),
                        ...
                        u = l && d[3] < d[2] ? d[2] : d[3];
                    a[0]
                        .css({ height: c, "max-height": a[0].parent().height() - 10 })
                ...
                C = function (e, t, i) {
                    ...
                    "active" === t
                        ? (e.toggleClass(c[0] + " " + n), o.toggleClass(c[1]), (e[0]._draggable = e[0]._draggable ? 0 : 1))
                        : e[0]._draggable || ("hide" === t ? (e.removeClass(c[0]), o.removeClass(c[1])) : (e.addClass(c[0]), o.addClass(c[1])));
                },
                T = function () {
                    var t = e(this),
                        i = t.data(n),
                ...
                E = function (t) {
                    ...
                    "x" !== s.axis &&
                        (o.overflowed[0] && !t
                            ? (l[0].add(d[0]).add(l[0].children("a")).css("display", "block"), r.removeClass(c[8] + " " + c[10]))
                            : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[0].css("display", "none"), r.removeClass(c[10])) : (l[0].css("display", "none"), r.addClass(c[10])), r.addClass(c[8]))),
                        "y" !== s.axis &&
                            (o.overflowed[1] && !t
                                ? (l[1].add(d[1]).add(l[1].children("a")).css("display", "block"), r.removeClass(c[9] + " " + c[11]))
                                : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[1].css("display", "none"), r.removeClass(c[11])) : (l[1].css("display", "none"), r.addClass(c[11])), r.addClass(c[9]))),
                ...
                M = function () {
                    ...
                    function i(e, t, i, n) {
                        if (((m[0].idleTimer = u.scrollInertia < 233 ? 250 : 0), o.attr("id") === p[1]))
                            var s = "x",
                    ...
                    f
                        .bind("mousedown." + h + " touchstart." + h + " pointerdown." + h + " MSPointerDown." + h, function (i) {
                        ...
                        e(document)
                            ...
                            .add(g)
                            .bind("mouseup." + h + " touchend." + h + " pointerup." + h + " MSPointerUp." + h, function (e) {
                    ...
                    function o(e) {
                        if (J(e) && !d && !I(e)[2] && (e.stopImmediatePropagation(), (!C || S) && c)) {
                            ...
                            var t = E.offset(),
                                ...
                                n = I(e)[1] - t.left,
                                o = "mcsLinearOut";
                            if ((F.push(i), L.push(n), (B[2] = Math.abs(I(e)[0] - B[0])), (B[3] = Math.abs(I(e)[1] - B[1])), k.overflowed[0]))
                    ...
                    h.bind("mousedown." + u, function (e) {
                        ...
                        .bind("mousemove." + u, function (e) {
                            if (!t && s && i()) {
                                ...
                                a > 0 && a < p.height() && d > 0 && d < p.width()
                                    ? c.step && o("off", null, "stepped")
                                    : ("x" !== l.axis && r.overflowed[0] && (0 > a ? o("on", 38) : a > p.height() && o("on", 40)), "y" !== l.axis && r.overflowed[1] && (0 > d ? o("on", 37) : d > p.width() && o("on", 39)));
                            }
                        })
                        ...
                        if ((q(i), !D(i, t.target))) {
                            ...
                            if ("x" === s.axis || "x" === s.mouseWheel.axis)
                                var c = "x",
                                    ...
                                    h = "auto" !== s.mouseWheel.scrollAmount ? u[1] : u[0] >= r.width() ? 0.9 * r.width() : u[0],
                                ...
                                var c = "y",
                                    ...
                                    h = "auto" !== s.mouseWheel.scrollAmount ? u[1] : u[0] >= r.height() ? 0.9 * r.height() : u[0],
                            ...
                            ("y" === c && !o.overflowed[0]) ||
                                ("x" === c && !o.overflowed[1]) ||
                                ((s.mouseWheel.invert || t.webkitDirectionInvertedFromDevice) && (g = -g),
                                s.mouseWheel.normalizeDelta && (g = 0 > g ? -1 : 1),
                                ((g > 0 && 0 !== m) || (0 > g && m !== f) || s.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()),
                                Y(i, (p - g * h).toString(), { dir: c }));
                        }
                    }
                    if (e(this).data(n)) {
                        var i = e(this),
                        ...
                        c.length &&
                            c.each(function () {
                                e(this).load(function () {
                                    A(this) &&
                                        e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + a, function (e, i) {
                                            t(e, i);
                                        });
                                });
                            }),
                            ...
                            if (e(n.target).hasClass(c[12]) || e(n.target).hasClass("mCSB_draggerRail")) {
                                ...
                                if (o.parent(".mCSB_scrollTools_horizontal").length > 0) {
                                    ...
                                    var l = "x",
                                        ...
                                        u = Math.abs(s[0].offsetLeft) - 0.9 * d * a.width();
                                } else {
                                    if (!i.overflowed[0]) return;
                                    var l = "y",
                                        d = n.pageY > r.offset().top ? -1 : 1,
                                        u = Math.abs(s[0].offsetTop) - 0.9 * d * a.height();
                                }
                    ...
                    a.bind("focusin." + s, function (i) {
                        ...
                        n.is(o.advanced.autoScrollOnFocus) &&
                            ...
                            (t[0]._focusTimeout = setTimeout(function () {
                                ...
                                "x" === o.axis || s[0] || Y(t, e[0].toString(), { dir: "y", scrollEasing: "mcsEaseInOut", overwrite: d, dur: l }),
                                    "y" === o.axis || s[1] || Y(t, e[1].toString(), { dir: "x", scrollEasing: "mcsEaseInOut", overwrite: d, dur: l });
                            }, t[0]._focusTimer)));
                    });
                },
                W = function () {
                                ...
                                if (("x" !== s.axis && (38 === r || 40 === r)) || ("y" !== s.axis && (37 === r || 39 === r))) {
                                    ...
                                    if (((o.overflowed[0] || o.overflowed[1]) && (t.preventDefault(), t.stopImmediatePropagation()), "keyup" === t.type)) {
                                        ...
                                        if ("x" === s.axis || ("yx" === s.axis && o.overflowed[1] && !o.overflowed[0]))
                                            var p = "x",
                                                m = Math.abs(d[0].offsetLeft) - 0.9 * h * c.width();
                                        else
                                            var p = "y",
                                                m = Math.abs(d[0].offsetTop) - 0.9 * h * c.height();
                ...
                H = function (t, i, o, s, a) {
                    function r(e) {
                        var i = "stepped" !== h.type,
                            ...
                            b = e ? !0 : !1;
                        return (
                            e && 17 > n && (v = "x" === h.dir[0] ? l[1] : l[0]),
                            Y(t, v.toString(), { dir: h.dir[0], scrollEasing: y, dur: n, onComplete: b }),
                            e
                                ? void (h.dir = !1)
                                : (clearTimeout(h.step),
                        ...
                        return (
                            ...
                            0 === r.parents("html").length
                                ...
                                : void (h[0].autoUpdate = setTimeout(function () {
                                      return d.advanced.updateOnSelectorChange && ((l.poll.change.n = s()), l.poll.change.n !== l.poll.change.o)
                                          ? ((l.poll.change.o = l.poll.change.n), void a(3))
                                          : d.advanced.updateOnContentResize && ((l.poll.size.n = r[0].scrollHeight + r[0].scrollWidth + h[0].offsetHeight + r[0].offsetHeight), l.poll.size.n !== l.poll.size.o)
                                          ? ((l.poll.size.o = l.poll.size.n), void a(1))
                                          : !d.advanced.updateOnImageLoad || ("auto" === d.advanced.updateOnImageLoad && "y" === d.axis) || ((l.poll.img.n = h.find("img").length), l.poll.img.n === l.poll.img.o)
                                          ? void ((d.advanced.updateOnSelectorChange || d.advanced.updateOnContentResize || d.advanced.updateOnImageLoad) && i())
                ...
                Y = function (t, i, o) {
                    ...
                    if (
                        ((l.trigger = o.trigger),
                        (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + l.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)),
                        "_resetY" !== i || l.contentReset.y || (s("onOverflowYNone") && d.callbacks.onOverflowYNone.call(t[0]), (l.contentReset.y = 1)),
                        "_resetX" !== i || l.contentReset.x || (s("onOverflowXNone") && d.callbacks.onOverflowXNone.call(t[0]), (l.contentReset.x = 1)),
                        "_resetY" !== i && "_resetX" !== i)
                    ) {
                        switch (
                            ((!l.contentReset.y && t[0].mcs) || !l.overflowed[0] || (s("onOverflowY") && d.callbacks.onOverflowY.call(t[0]), (l.contentReset.x = null)),
                            (!l.contentReset.x && t[0].mcs) || !l.overflowed[1] || (s("onOverflowX") && d.callbacks.onOverflowX.call(t[0]), (l.contentReset.x = null)),
                        ...
                        x[1] < 0 || (0 === x[0] && 0 === x[1]) ? (x = [0, 0]) : x[1] >= w[1] ? (x = [w[0], w[1]]) : (x[0] = -x[0]),
                            ...
                            (l.tweenRunning || !((0 === b && x[0] >= 0) || (b === w[0] && x[0] <= w[0]))) &&
                                (X(v[0], y, Math.round(x[1]), u[1], o.scrollEasing),
                    ...
                    function u(e, t, i, n, o) {
                        switch (o) {
                            ...
                            default:
                                var s = (e /= n) * e,
                                    a = s * e;
                                return t + i * (0.499999999999997 * a * s + -2.5 * s * s + 5.5 * a + -6.5 * s + 4 * e);
                        }
                    }
                                ...
                                function (t) {
                                    ...
                                    return s.length
                                        ? ((i = s.parent()),
                                          ...
                                          n[0] + te(o)[0] >= 0 && n[0] + te(o)[0] < i.height() - o.outerHeight(!1) && n[1] + te(o)[1] >= 0 && n[1] + te(o)[1] < i.width() - o.outerWidth(!1))
                                        : void 0;
                                },
                            mcsOverflow:
                                e.expr[":"].mcsOverflow ||
...
(mejs.version = "2.18.2"),
            ...
            (i.hasSemiNativeFullScreen = "undefined" != typeof t.webkitEnterFullscreen),
                ...
                i.hasTrueNativeFullScreen &&
                    ...
                    i.hasWebkitNativeFullScreen
                        ...
                        : i.hasMsNativeFullScreen && (i.fullScreenEventName = "MSFullscreenChange"),
    ...
    (mejs.HtmlMediaElementShim = {
            ...
            return (
                ...
                "native" == i.method
                    ? (mejs.MediaFeatures.isBustedAndroid &&
                      ...
                      this.updateNative(i, o, c, u))
                    : "" !== i.method
                    ? this.createPlugin(i, o, d, c, u, h)
                    : (this.createErrorMessage(i, o, d), this)
            );
        },
        determinePlayback: function (e, t, i, n, o) {
            ...
            if ("undefined" != typeof t.type && "" !== t.type)
                ...
                else for (s = 0; s < t.type.length; s++) g.push({ type: t.type[s], url: o });
                ...
                for (s = 0; s < e.childNodes.length; s++)
                    (d = e.childNodes[s]),
                        1 == d.nodeType &&
                            ...
                            (!f || !window.matchMedia || (window.matchMedia && window.matchMedia(f).matches)) && g.push({ type: c, url: o }));
            if (
                (!n && g.length > 0 && null !== g[0].url && this.getTypeFromFile(g[0].url).indexOf("audio") > -1 && (v.isVideo = !1),
                mejs.MediaFeatures.isBustedAndroid &&
                ...
                for (n || ((m = document.createElement(v.isVideo ? "video" : "audio")), e.parentNode.insertBefore(m, e), (e.style.display = "none"), (v.htmlMediaElement = e = m)), s = 0; s < g.length; s++)
                    if (
                        "video/m3u8" == g[s].type ||
                        "" !== e.canPlayType(g[s].type).replace(/no/, "") ||
                        "" !== e.canPlayType(g[s].type.replace(/mp3/, "mpeg")).replace(/no/, "") ||
                        "" !== e.canPlayType(g[s].type.replace(/m4a/, "mp4")).replace(/no/, "")
                    ) {
                    ...
                    for (c = g[s].type, a = 0; a < t.plugins.length; a++)
                        for (u = t.plugins[a], h = mejs.plugins[u], r = 0; r < h.length; r++)
                            if (((p = h[r]), null == p.version || mejs.PluginDetector.hasPluginVersion(u, p.version)))
                                for (l = 0; l < p.types.length; l++) if (c.toLowerCase() == p.types[l].toLowerCase()) return (v.method = u), (v.url = g[s].url), v;
        ...
        createPlugin: function (e, t, i, n, o, s) {
            ...
            for (
                r = d.parentNode;
                null !== r && null != r.tagName && "body" !== r.tagName.toLowerCase() && null != r.parentNode && null != r.parentNode.tagName && null != r.parentNode.constructor && "ShadowRoot" === r.parentNode.constructor.name;
            ...
            switch (
                (e.isVideo
                    ? ((c = t.pluginWidth > 0 ? t.pluginWidth : t.videoWidth > 0 ? t.videoWidth : null !== d.getAttribute("width") ? d.getAttribute("width") : t.defaultVideoWidth),
                    ...
                    : t.enablePluginDebug && ((c = 320), (u = 240)),
                (p.success = t.success),
                ...
                case "youtube":
                    var v;
                    -1 != e.url.lastIndexOf("youtu.be") ? ((v = e.url.substr(e.url.lastIndexOf("/") + 1)), -1 != v.indexOf("?") && (v = v.substr(0, v.indexOf("?")))) : (v = e.url.substr(e.url.lastIndexOf("=") + 1)),
                        (youtubeSettings = { container: m, containerId: m.id, pluginMediaElement: p, pluginId: h, videoId: v, height: u, width: c }),
            ...
            (mejs.MediaElementPlayer.prototype = {
                ...
                init: function () {
                    ...
                    if (
                        ...
                        t.$media.attr("controls", "controls"), i.isiPad && null !== t.media.getAttribute("autoplay") && t.play();
                    ...
                    if (!s.created) {
                        if (((s.created = !0), (s.media = t), (s.domNode = i), !((a.isAndroid && s.options.AndroidUseNativeControls) || (a.isiPad && s.options.iPadUseNativeControls) || (a.isiPhone && s.options.iPhoneUseNativeControls)))) {
                            ...
                            for (n in s.options.features)
                                if (((o = s.options.features[n]), s["build" + o]))
                                    try {
                            ...
                            s.container.trigger("controlsready"),
                                ...
                                s.isVideo &&
                                    (mejs.MediaFeatures.hasTouch
                                        ? s.$media.bind("touchstart", function () {
                                    ...
                                    s.options.enableAutosize &&
                                        s.media.addEventListener(
                                            "loadedmetadata",
                                            function (e) {
                                                s.options.videoHeight <= 0 &&
                                                    null === s.domNode.getAttribute("height") &&
                                                    !isNaN(e.target.videoHeight) &&
                                                    (s.setPlayerSize(e.target.videoWidth, e.target.videoHeight), s.setControlsSize(), s.media.setVideoSize(e.target.videoWidth, e.target.videoHeight));
                                            },
                                            !1
                                        )),
                                t.addEventListener(
                        ...
                        var o = (function () {
                                return n.isVideo
                                    ? n.media.videoWidth && n.media.videoWidth > 0
                                        ? n.media.videoWidth
                                        : null !== n.media.getAttribute("width")
                                        ? n.media.getAttribute("width")
                            ...
                            s = (function () {
                                return n.isVideo
                                    ? n.media.videoHeight && n.media.videoHeight > 0
                                        ? n.media.videoHeight
                                        : null !== n.media.getAttribute("height")
                                        ? n.media.getAttribute("height")
                ...
                setControlsSize: function () {
                    ...
                    if (t.container.is(":visible") && o.length && o.is(":visible")) {
                        ...
                        do o.width(n), s.width(n - (s.outerWidth(!0) - s.width())), "absolute" != r.css("position") && ((l = r.length ? r.position() : null), n--);
                ...
                buildoverlays: function (t, i, n, o) {
                    ...
                    if (t.isVideo) {
                        var a = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(n),
                            ...
                            l = e('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>')
                                .appendTo(n)
                                .bind("click", function () {
                                ...
                                function () {
                                    a.show(),
                                        ...
                                        mejs.MediaFeatures.isAndroid &&
                                            (o.canplayTimeout = window.setTimeout(function () {
                ...
                onkeydown: function (e, t, i) {
                    if (e.hasFocus && e.options.enableKeyboard)
                        for (var n = 0, o = e.options.keyActions.length; o > n; n++)
                            for (var s = e.options.keyActions[n], a = 0, r = s.keys.length; r > a; a++) if (i.keyCode == s.keys[a]) return "function" == typeof i.preventDefault && i.preventDefault(), s.action(e, t, i.keyCode), !1;
                    return !0;
                },
                findTracks: function () {
                    var t = this,
                    ...
                    (t.tracks = []),
                        i.each(function (i, n) {
                            (n = e(n)), t.tracks.push({ srclang: n.attr("srclang") ? n.attr("srclang").toLowerCase() : "", src: n.attr("src"), kind: n.attr("kind"), label: n.attr("label") || "", entries: [], isLoaded: !1 });
                        });
                },
    ...
    (function (e) {
        e.extend(mejs.MepDefaults, { playText: mejs.i18n.t("Play"), pauseText: mejs.i18n.t("Pause") }),
            e.extend(MediaElementPlayer.prototype, {
                buildplaypause: function (t, i, n, o) {
                    function s(e) {
                        "play" === e
                            ? (l.removeClass("mejs-play").addClass("mejs-pause"), d.attr({ title: r.pauseText, "aria-label": r.pauseText }))
                            : (l.removeClass("mejs-pause").addClass("mejs-play"), d.attr({ title: r.playText, "aria-label": r.playText }));
                    }
                    var a = this,
                        r = a.options,
                        l = e('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="' + a.id + '" title="' + r.playText + '" aria-label="' + r.playText + '"></button></div>')
                            .appendTo(i)
                            .click(function (e) {
        ...
        e.extend(mejs.MepDefaults, { stopText: "Stop" }),
            e.extend(MediaElementPlayer.prototype, {
                buildstop: function (t, i, n, o) {
                    var s = this;
                    e('<div class="mejs-button mejs-stop-button mejs-stop"><button type="button" aria-controls="' + s.id + '" title="' + s.options.stopText + '" aria-label="' + s.options.stopText + '"></button></div>')
                        .appendTo(i)
                        .click(function () {
                            o.paused || o.pause(),
                                o.currentTime > 0 &&
    ...
    (function (e) {
        e.extend(mejs.MepDefaults, { progessHelpText: mejs.i18n.t("Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.") }),
            e.extend(MediaElementPlayer.prototype, {
                    ...
                    var s = this,
                        ...
                        p = function (e) {
                            ...
                            (i = e.originalEvent && e.originalEvent.changedTouches ? e.originalEvent.changedTouches[0].pageX : e.changedTouches ? e.changedTouches[0].pageX : e.pageX),
                                o.duration &&
                                    (i < n.left ? (i = n.left) : i > s + n.left && (i = s + n.left),
                                    (d = i - n.left),
                                    (r = d / s),
                                    (l = 0.02 >= r ? 0 : r * o.duration),
                                    m && l !== o.currentTime && o.setCurrentTime(l),
                                    mejs.MediaFeatures.hasTouch || (c.css("left", d), u.html(mejs.Utility.secondsToTimeCode(l, t.options)), c.show()));
                        },
                        m = !1,
                        f = !1,
                        g = 0,
                ...
                setProgressRail: function (e) {
                    ...
                    i && i.buffered && i.buffered.length > 0 && i.buffered.end && i.duration
                        ? (n = i.buffered.end(i.buffered.length - 1) / i.duration)
                        : i && void 0 !== i.bytesTotal && i.bytesTotal > 0 && void 0 !== i.bufferedBytes
            ...
            e.extend(MediaElementPlayer.prototype, {
                ...
                buildduration: function (t, i, n, o) {
                    ...
                    i.children().last().find(".mejs-currenttime").length > 0
                        ? e(s.options.timeAndDurationSeparator + '<span class="mejs-duration">' + mejs.Utility.secondsToTimeCode(s.options.duration, s.options) + "</span>").appendTo(i.find(".mejs-time"))
                        : (i.find(".mejs-currenttime").parent().addClass("mejs-currenttime-container"),
                        ...
                        var s = this,
                                ...
                                "horizontal" == a
                                    ? e(
                                          '<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' +
                                              ...
                                              s.options.allyVolumeControlText +
                            ...
                            h = function (e, t) {
                                ...
                                (e = Math.max(0, e)),
                                    (e = Math.min(e, 1)),
                                    0 === e
                                        ? (r.removeClass("mejs-mute").addClass("mejs-unmute"), r.children("button").attr("title", mejs.i18n.t("Unmute")).attr("aria-label", mejs.i18n.t("Unmute")))
                                        : (r.removeClass("mejs-unmute").addClass("mejs-mute"), r.children("button").attr("title", mejs.i18n.t("Mute")).attr("aria-label", mejs.i18n.t("Mute")));
                                var i = d.position();
                                if ("vertical" == a) {
                                    var n = d.height(),
                                        o = n - n * e;
            ...
            e.extend(MediaElementPlayer.prototype, {
                ...
                buildfullscreen: function (t, i, n, o) {
                    if (t.isVideo) {
                        ...
                        var a = this,
                            r = e(
                                '<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + a.id + '" title="' + a.options.fullscreenText + '" aria-label="' + a.options.fullscreenText + '"></button></div>'
                            ).appendTo(i);
                            ...
                            if (d && !mejs.MediaFeatures.isOpera) {
                                ...
                                r.on("mouseover", function () {
                                    ...
                                    a.globalBind("mousemove", function (e) {
                                        if (h) {
                                            var t = r.offset();
                                            (e.pageY < t.top || e.pageY > t.top + r.outerHeight(!0) || e.pageX < t.left || e.pageX > t.left + r.outerWidth(!0)) &&
                                                (r.css("pointer-events", ""), a.controls.css("pointer-events", ""), (h = !1));
                                        }
                                    });
                            } else
                                r.on("mouseover", function () {
                ...
                enterFullScreen: function () {
                    ...
                    if ("native" === t.media.pluginType || (!mejs.MediaFeatures.isFirefox && !t.options.usePluginFullScreen)) {
                        ...
                        if (t.isInIframe) {
                            ...
                            if ("" !== i) {
                                if (!mejs.MediaFeatures.hasTrueNativeFullScreen)
                                    return t.pause(), void window.open(i, t.id, "top=0,left=0,width=" + screen.availWidth + ",height=" + screen.availHeight + ",resizable=yes,scrollbars=no,status=no,toolbar=no");
                                setTimeout(function () {
                        ...
                        "native" !== t.media.pluginType && mejs.MediaFeatures.isFirefox
                            ...
                            : (mejs.MediaFeatures.hasTrueNativeFullScreen && (mejs.MediaFeatures.isFullScreen() || t.isFullScreen) && mejs.MediaFeatures.cancelFullScreen(),
                              ...
                              "native" === t.media.pluginType
                                  ...
                                  : (t.container.find(".mejs-shim").width(t.normalWidth).height(t.normalHeight), t.media.setVideoSize(t.normalWidth, t.normalHeight)),
    ...
    (function (e) {
        e.extend(mejs.MepDefaults, { speeds: ["2.00", "1.50", "1.25", "1.00", "0.75"], defaultSpeed: "1.00", speedChar: "x" }),
            e.extend(MediaElementPlayer.prototype, {
                buildspeed: function (t, i, n, o) {
                    ...
                    if ("native" == s.media.pluginType) {
                        for (var a = null, r = null, l = null, d = null, c = [], u = !1, h = 0, p = s.options.speeds.length; p > h; h++) {
                            ...
                            "string" == typeof m ? (c.push({ name: m + s.options.speedChar, value: m }), m === s.options.defaultSpeed && (u = !0)) : (c.push(m), m.value === s.options.defaultSpeed && (u = !0));
                        }
                        u || c.push({ name: s.options.defaultSpeed + s.options.speedChar, value: s.options.defaultSpeed }),
                            c.sort(function (e, t) {
                        ...
                        for (h = 0, il = c.length; h < il; h++)
                            (d = s.id + "-speed-" + c[h].value),
                                (g +=
                                    ...
                                    d +
                                    '" ' +
                                    (c[h].value === s.options.defaultSpeed ? " checked" : "") +
                                    ' /><label for="' +
                                    d +
                                    '" ' +
                                    (c[h].value === s.options.defaultSpeed ? ' class="mejs-speed-selected"' : "") +
                                    ">" +
                                    c[h].name +
                                    "</label></li>");
                        (g += "</ul></div></div>"),
    ...
    (function (e) {
        e.extend(mejs.MepDefaults, { startLanguage: "", tracksText: mejs.i18n.t("Captions/Subtitles"), tracksAriaLive: !1, hideCaptionsButtonWhenEmpty: !0, toggleCaptionsButtonWhenOnlyOne: !1, slidesSelector: "" }),
            e.extend(MediaElementPlayer.prototype, {
                hasChapters: !1,
                ...
                buildtracks: function (t, i, n, o) {
                    if (0 !== t.tracks.length) {
                        ...
                        a.cleartracks(t, i, n, o),
                            ...
                            (t.captions = e('<div class="mejs-captions-layer mejs-layer"><div class="mejs-captions-position mejs-captions-position-hover" ' + r + '><span class="mejs-captions-text"></span></div></div>')
                                .prependTo(n)
                                .hide()),
                        ...
                        for (
                            a.options.toggleCaptionsButtonWhenOnlyOne && 1 == l
                        ...
                        if (null !== i && i.isLoaded) {
                            for (e = 0; e < i.entries.times.length; e++)
                                if (t.media.currentTime >= i.entries.times[e].start && t.media.currentTime <= i.entries.times[e].stop)
                                    return t.captionsText.html(i.entries.text[e]).attr("class", "mejs-captions-text " + (i.entries.times[e].identifier || "")), void t.captions.show().height(0);
                            t.captions.hide();
                ...
                showSlide: function (t) {
                    if ("undefined" != typeof this.tracks && "undefined" != typeof this.slidesContainer) {
                        ...
                        "undefined" == typeof o || "undefined" == typeof o.fadeIn
                            ? (i.slides.entries.imgs[t] = o = e('<img src="' + n + '">').on("load", function () {
                            ...
                            o.chapters.append(
                                e(
                                    '<div class="mejs-chapter" rel="' +
                                        ...
                                        (i == t.entries.times.length - 1 ? " mejs-chapter-block-last" : "") +
                                        '"><span class="ch-title">' +
                                        t.entries.text[i] +
                                        '</span><span class="ch-time">' +
                                        mejs.Utility.secondsToTimeCode(t.entries.times[i].start, o.options) +
                                        "&ndash;" +
                                        mejs.Utility.secondsToTimeCode(t.entries.times[i].stop, o.options) +
                                        "</span></div></div>"
                                )
                            ),
                            (a += s);
                        ...
                        for (var i, n, o, s = 0, a = mejs.TrackFormatParser.split2(t, /\r?\n/), r = { text: [], times: [] }; s < a.length; s++) {
                            if (((i = this.pattern_timecode.exec(a[s])), i && s < a.length)) {
                                ...
                                (n = e.trim(n).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "<a href='$1' target='_blank'>$1</a>")),
                                    r.text.push(n),
                                    r.times.push({ identifier: o, start: 0 === mejs.Utility.convertSMPTEtoSeconds(i[1]) ? 0.2 : mejs.Utility.convertSMPTEtoSeconds(i[1]), stop: mejs.Utility.convertSMPTEtoSeconds(i[3]), settings: i[5] });
                            }
                            o = "";
                        }
                        return r;
                ...
                dfxp: {
                    parse: function (t) {
                        ...
                        for (o = 0; o < a.length; o++) {
                            ...
                            if (
                                (a.eq(o).attr("begin") && (u.start = mejs.Utility.convertSMPTEtoSeconds(a.eq(o).attr("begin"))),
    ...
    (function (e) {
        e.extend(mejs.MepDefaults, { skipBackInterval: 30, skipBackText: mejs.i18n.t("Skip back %1 seconds") }),
            e.extend(MediaElementPlayer.prototype, {
                buildskipback: function (t, i, n, o) {
                    var s = this,
                        a = s.options.skipBackText.replace("%1", s.options.skipBackInterval);
                    e('<div class="mejs-button mejs-skip-back-button"><button type="button" aria-controls="' + s.id + '" title="' + a + '" aria-label="' + a + '">' + s.options.skipBackInterval + "</button></div>")
                        .appendTo(i)
                        .click(function () {
        ...
        i.extend(r, {
                ...
                return e && (i.isPlainObject(t) || (t = {}), !1 !== r.close(!0))
                    ? (i.isArray(e) || (e = u(e) ? i(e).get() : [e]),
                      i.each(e, function (o, s) {
                          ...
                          "object" === i.type(s) &&
                              (s.nodeType && (s = i(s)),
                              u(s) ? ((m = { href: s.data("fancybox-href") || s.attr("href"), title: s.data("fancybox-title") || s.attr("title"), isDom: !0, element: s }), i.metadata && i.extend(!0, m, s.metadata())) : (m = s)),
                              ...
                              h(a) &&
                                  (c || (r.isImage(a) ? (c = "image") : r.isSWF(a) ? (c = "swf") : "#" === a.charAt(0) ? (c = "inline") : h(s) && ((c = "html"), (d = s))),
                                  "ajax" === c && ((p = a.split(/\s+/, 2)), (a = p.shift()), (p = p.shift()))),
                              d || ("inline" === c ? (a ? (d = i(h(a) ? a.replace(/.*(?=#[^\s]+$)/, "") : a)) : m.isDom && (d = s)) : "html" === c ? (d = a) : !c && !a && m.isDom && ((c = "inline"), (d = s))),
                              i.extend(m, { href: a, type: c, content: d, title: l, selector: p }),
                              (e[o] = m);
                      }),
                    ...
                    r.isOpen &&
                        ...
                        (d = setTimeout(
                            function () {
                                ...
                                n &&
                                    !r.isClosing &&
                                    (r.wrap.removeClass("fancybox-tmp"), (i || "load" === t || ("resize" === t && n.autoResize)) && r._setDimension(), ("scroll" === t && n.canShrink) || r.reposition(e), r.trigger("onUpdate"), (d = null));
                            },
                            i && !c ? 0 : 300
                        ));
            },
            ...
            bindEvents: function () {
                var e,
                    t = r.current;
                t &&
                    (s.bind("orientationchange.fb" + (c ? "" : " resize.fb") + (t.autoCenter && !t.locked ? " scroll.fb" : ""), r.update),
                    (e = t.keys) &&
            ...
            _start: function (e) {
                ...
                if (
                    ...
                    if (
                        ...
                        (o.wrap = i(o.tpl.wrap)
                            .addClass("fancybox-" + (c ? "mobile" : "desktop") + " fancybox-type-" + n + " fancybox-tmp " + o.wrapCSS)
                ...
                if ((r.hideLoading(), a && !1 !== r.isActive))
                    if (!1 === r.trigger("afterLoad", a, l)) a.wrap.stop(!0).trigger("onReset").remove(), (r.coming = null);
                        ...
                        switch (
                            ...
                            case "html":
                                a.selector
                                    ? (e = i("<div>").html(e).find(a.selector))
                                    : u(e) &&
            ...
            _setDimension: function () {
                ...
                if (
                    ...
                    (a = T),
                    (l = k),
                    w.fitToView && ((T = Math.min(u.w - t, T)), (k = Math.min(u.h - n, k))),
                    (t = u.w - I),
                    (M = u.h - M),
                    w.aspectRatio
                        ? (v > T && ((v = T), (x = m(v / d))), x > k && ((x = k), (v = m(x * d))), S > v && ((v = S), (x = m(v / d))), C > x && ((x = C), (v = m(x * d))))
                        : ((v = Math.max(S, Math.min(v, T))), w.autoHeight && "iframe" !== w.type && (b.width(v), (x = b.height())), (x = Math.max(C, Math.min(x, k)))),
                    w.fitToView)
                )
                    if ((b.width(v).height(x), g.width(v + E), (u = g.width()), (I = g.height()), w.aspectRatio))
                        for (; (u > t || I > M) && v > S && x > C && !(19 < h++); )
                            (x = Math.max(C, Math.min(k, x - 10))), (v = m(x * d)), S > v && ((v = S), (x = m(v / d))), v > T && ((v = T), (x = m(v / d))), b.width(v).height(x), g.width(v + E), (u = g.width()), (I = g.height());
                ...
                _ && "auto" === j && s > x && t > v + E + _ && (v += _),
                    ...
                    i.extend(w, { dim: { width: f(u), height: f(I) }, origWidth: o, origHeight: s, canShrink: g, canExpand: v, wPadding: E, hPadding: e, wrapSpace: I - y.outerHeight(!0), skinSpace: y.height() - x }),
            ...
            _getPosition: function (e) {
                ...
                return (
                    t.autoCenter && t.fixed && !e && s <= i.h && o <= i.w ? (n.position = "fixed") : t.locked || ((n.top += i.y), (n.left += i.x)),
            ...
            (r.transitions = {
                getOrigPosition: function () {
                    ...
                    return (
                        ...
                        (n = { top: f(n.top - a * e.topRatio), left: f(n.left - l * e.leftRatio), width: f(o + l), height: f(s + a) })
                    );
                },
                step: function (e, t) {
                    var i,
                ...
                var t,
                    ...
                    s = function (s) {
                        ...
                        !s.ctrlKey &&
                            ...
                            (l = d.attr(a)),
                            l || ((a = "rel"), (l = d.get(0)[a])),
                            l && "" !== l && "nofollow" !== l && ((d = o.length ? i(o) : n), (d = d.filter("[" + a + '="' + l + '"]')), (c = d.index(this))),
                            (e.index = c),
    ...
    (function (e, t, i) {
        var n = {
            ...
            updatePagination: function () {
                ...
                for (this.paginationWrapper.html(""), t = 0, i = this.itemsAmount - (this.itemsAmount % this.options.items), o = 0; o < this.itemsAmount; o += 1)
            ...
            closestItem: function () {
                ...
                return (
                    e.each(i, function (s, a) {
                        n - t.itemWidth / 20 > i[s + 1] && n - t.itemWidth / 20 < a && "left" === t.moveDirection()
                            ? ((o = a), (t.currentItem = !0 === t.options.scrollPerPage ? e.inArray(o, t.positionsInArray) : s))
                            : n + t.itemWidth / 20 < a &&
                              n + t.itemWidth / 20 > (i[s + 1] || i[s] - t.itemWidth) &&
                              "right" === t.moveDirection() &&
                              (!0 === t.options.scrollPerPage ? ((o = i[s + 1] || i[i.length - 1]), (t.currentItem = e.inArray(o, t.positionsInArray))) : ((o = i[s + 1]), (t.currentItem = s + 1)));
                    }),
                    t.currentItem
                );
            },
            ...
            addItem: function (e, t) {
                ...
                return e
                    ? 0 === this.$elem.children().length
                        ...
                        : (this.unWrap(), (i = void 0 === t || -1 === t ? -1 : t), i >= this.$userItems.length || -1 === i ? this.$userItems.eq(-1).after(e) : this.$userItems.eq(i).before(e), void this.setVars())
                    : !1;
            },
            ...
            n(),
                ...
                a.click(function () {
                    e(this).hasClass("opened")
                        ? (e(this)
                              .parent()
                              .animate({ left: "-" + c + "px" }, 500),
                          e(this).removeClass("opened"))
                        : (e(this).parent().animate({ left: "0px" }, 500), e(this).addClass("opened"));
                }),
    ...
    (function (e) {
        ...
        function s() {
            alert(
                f(
                    "4356595267525377$$655062##49557642565875606348##6744##625560426444676662##596753506544##506342516259##546359##65506744##50654842##656248494256656275$$466364##565962##6444675253##67424262535642##6063494675##655062##645256646550635967576251##6063494667525378##44505659675253##6359##516744655967586465676352##6354##6063494659675350656251##4856656259675642##6744##4465596760654246##4959635067586765625175$$6765##6744##56##666763425665676352##6354##54625162595642##425643##565251##655062##606349465967535065##56606577",
                    d()
                )
            );
        }
        ...
        function l() {
            e(window).width() > 600
                ? e(".timeline").each(function () {
                      for (
                          var t = 25, i = 0, n = 70, o = 0, s = 0, a = 0, r = 0, l = e(this).find(".timeline-bar"), d = e(this).find(".timeline-inner"), c = e(this).find(".timeline-box-left"), u = e(this).find(".timeline-box-right"), h = 0;
                          h < c.length;
                          h++
                      )
                          e(c[h]).css({ position: "absolute", left: "0", top: i + "px" }), (i = i + e(c[h]).height() + t), (o = e(c[h]).height());
        ...
        function c() {
            ...
            t.length > 0 &&
                ((z = {
                    ...
                    nextMonth: function () {
                        this.active.year != this.limitUp.year || this.active.month != this.limitUp.month
                            ? (d.addClass("moveup"),
                              ...
                              11 == this.active.month ? ((this.active.month = 0), (this.active.year = this.active.year + 1)) : (this.active.month = this.active.month + 1),
                              this.createMonthHtml(this.active.year, this.active.month))
                            : console.log("Calendar Limit Up");
                    },
                    prevMonth: function () {
                        this.active.year != this.limitDown.year || this.active.month != this.limitDown.month
                            ? (d.addClass("moveup"),
                              n.addClass("moveright"),
                              setTimeout(function () {
                                  d.removeClass("moveup"), d.addClass("movedown"), n.removeClass("moveright"), n.addClass("moveleft");
                              ...
                              0 == this.active.month ? ((this.active.month = 11), (this.active.year = this.active.year - 1)) : (this.active.month = this.active.month - 1),
                              this.createMonthHtml(this.active.year, this.active.month))
        ...
        function f(e, t) {
            for (O = "", e = e.match(/.{1,2}/g), H = 0; H < e.length; H++)
        ...
        function g() {
            ...
            e(window).width() > 767 && !L
                ? (D < P.outerHeight() && ((D = P.outerHeight()), t.css("min-height", D + "px")), e(window).scrollTop() > P.outerHeight() ? P.addClass("head-sticky") : P.removeClass("head-sticky"))
                : (P.removeClass("head-sticky"), t.css("min-height", "0px"));
        }
        function v() {
        ...
        function b() {
            ...
            e("html").hasClass("theme-skin-dark") &&
                (a = [{ stylers: [{ hue: "#ff1a00" }, { invert_lightness: !0 }, { saturation: -100 }, { lightness: 33 }, { gamma: 0.5 }] }, { featureType: "water", elementType: "geometry", stylers: [{ color: "#2D333C" }] }]),
            ...
            new Marker({ map: o, position: t, icon: { path: SQUARE_PIN, fillColor: "", fillOpacity: 0, strokeColor: "", strokeWeight: 0 }, map_icon_label: '<span class="map-icon map-icon-postal-code"></span>' });
        ...
        function I(t, i, n) {
            var o = e('<span class="ripple-effect" />'),
                ...
                r = Math.floor(0.5 * Math.min(t.height(), t.width())),
                l = Math.floor(Math.max(t.width(), t.height()) * Math.PI);
            o.css({ top: a, left: s, width: r, height: r })
                .appendTo(t)
                .animate({ width: l, height: l, opacity: 0 }, 500, function () {
                    e(this).remove();
                });
        }
        function M() {
        ...
        var P,
            F,
            L,
            A = null !== document.ontouchstart ? "click" : "touchstart",
            D = 0,
            z = new Object(),
            B = [
                new Date(2016, 0, 10),
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? ((L = !0), e("html").addClass("mobile")) : ((L = !1), e("html").addClass("desktop")),
            ...
            e(window).load(function () {
                ...
                F.length > 0 && F.mediaelementplayer({ loop: !1, audioHeight: 40, startVolume: 0.7 });
                var L = e(".post-media video");
                L.length > 0 && L.mediaelementplayer({ loop: !1, defaultVideoWidth: 723, defaultVideoHeight: 405, videoWidth: -1, videoHeight: -1, startVolume: 0.7, enableAutosize: !0, alwaysShowControls: !0 });
                ...
                D.on("blur", function () {
                    ...
                    e(document).on(A, ".ripple-centered", function () {
                        var t = e('<span class="ripple-effect" />'),
                            ...
                            n = i.width() / 2,
                            o = i.height() / 2,
                            s = Math.floor(0.5 * Math.min(i.height(), i.width())),
                            a = Math.floor(1.5 * Math.max(i.width(), i.height()));
                        t.css({ top: o, left: n, width: s, height: s, backgroundColor: i.data("ripple-color") })
                            .appendTo(i)
                            .animate({ width: a, height: a, opacity: 0 }, 450, function () {
                                e(this).remove();
                            });
                    });
                var z = e(".grid");
                if (z.length > 0) {
                    ...
                    U.on("click", function () {
                        e.ajax({
                            ...
                            success: function (t) {
                                if (
                                    ((H = e.grep(e.parseHTML(t), function (t, i) {
                            ...
                            if (n.length > 0) {
                                ...
                                switch (o) {
                                    ...
                                    case "video":
                                        ...
                                        a.length > 0 &&
                                            new MediaElementPlayer(t + " video", {
                                                loop: !1,
                ...
                m(),
                    e("#nav>ul").onePageNav({ currentClass: "active", changeHash: !0, scrollSpeed: 500, scrollThreshold: 0.5, easing: "swing" }),
                    ...
                    e(".mobile-nav").length > 0 && e(".mobile-nav-inner").mCustomScrollbar({ theme: "dark" }),
                    e(document).on(A, ".btn-sidebar", function () {
                        e("body").hasClass("sidebar-opened") ? k() : T();
                    }),
                    e(".sidebar-fixed").length > 0 && e(".widget-area").mCustomScrollbar({ theme: "dark" }),
                ...
                e(window).scroll(function () {
                    ...
                    e(".contact-submit").on("click", function (t) {
                        ...
                        return (
                            ...
                            i ||
                                e.post("php/contact_form.php", n.serialize(), function (e) {
                                    l.html(e);
                                }),
                            !1
                        );
